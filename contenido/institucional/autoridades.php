...
<div class="margen">
	...
	<div class="alert alert-dark" role="alert" id="Autoridades Hospitalarias">
	   <h3>Autoridades Hospitalarias</h3>
	...
	<div class="alert alert-dark" role="alert" id="Autoridades Administrativas">
	    <h3>Autoridades Administrativas</h3>
