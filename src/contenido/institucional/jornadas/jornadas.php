...
<div class="row">
<div class="col-12">
	<img src="../../img/logo-jornadas.jpg" width="135px" height="120px" class="float-left"> <h3 class="mt-5">JORNADAS CIENTÍFICAS DEL INSTITUTO LANARI</h3>
</div>
</div>
  ...
  <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <a class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">Jornadas 2023</a>
  ...
  <div class="tab-content" id="v-pills-tabContent">
    ...
    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab"><!--Jornadas 2023-->
        <div class="row">
            <div class="col-lg-8">
                    <h4>Jornadas Científicas XVII 2023</h4>
                    <h5>Comisión Organizadora</h5>
                    <p> <strong>Presidenta:</strong> Rosana F. Marta</p>
                    <p><strong>Vice- Presidenta:</strong> Ana V. Ludueña</p>
                    <p><strong>Secretaria:</strong> Ana C. Glembotsky</p>
        ...
        <div class="row">
            <div class="col-lg-4">
                 <p>Miguel Etcheverria</p>
                 <p>Nora Goette</p>
                 <p>Patricia Indaburu</p>
                 <p>Pablo Landi</p>
                 <p>Gabriel Palacín</p> 
            </div>
            <div class="col-lg-4">
                  <p>Fernanda Rubio</p>
                  <p>Melisa Martinez Sayé</p>
                  <p>Juan Pablo Suarez</p>
                  <p>Verónica Verri</p>
            </div>
        </div>
        <div class="row">
            <p><strong>Muestra de arte:</strong></p>
