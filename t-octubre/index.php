...
/* Obtener la especialidad para esta fecha */
  ...
  // Verificar si se encontró la fecha de hoy
 if ($result->num_rows > 0) {
  ...
  if ($result->num_rows > 1) {
    ...
    $mensaje = "Hoy puede solicitar turno para " . $especialidad;
     if ($hora_actual <= '8:00' && $hora_actual >= '12:05') {
       $especialidad= "no";
    ...
    <form action="guardar_datos.php" method="POST">
        ...
        <div class="form-group">
            <label for="wsp">Teléfono para Whatsapp <br>
                Escriba el código de área sin el 0 y el número sin el 15 (ej: 1155553434)</label>
            <input type="text" class="form-control" id="wsp" name="wsp" maxlength="10" onblur="verificarLongitud()" required>
        </div>
        <div class="form-group">
